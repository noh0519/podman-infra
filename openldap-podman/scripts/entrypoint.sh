...
install -d -o openldap -g openldap -m 0700 /var/lib/ldap /etc/ldap/tls
...
EOF
    slapadd -f /run/slapd.conf -l /run/bootstrap.ldif
    chown -R openldap:openldap /var/lib/ldap
fi

exec /usr/sbin/slapd -d 0 -u openldap -g openldap -f /run/slapd.conf \
    -h "ldap:/// ldaps:///"
